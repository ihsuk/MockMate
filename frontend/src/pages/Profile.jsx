...
const inputBase = 'w-full bg-slate-50 dark:bg-slate-950 border-2 border-transparent dark:border-slate-800 rounded-xl sm:rounded-2xl p-3.5 sm-4 fornt-semibold text-slate-700 dark:text-slate-200 text-base transition-all focus:bg-white dark:focus:bg-slate-900 focus:border-teal-500 outline-none';
const Profile = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-6 sm:py-12 pb-24'>
      <div className='bg-white dark:bg-slate-900 rounded-3xl shadow-xl sm:shadow-2xl dark:shadow-none p-6 sm:p-12 border border-slate-100 dark:border-slate-800'>
        <header className='mb-8'>
          <h1 className='text-2xl sm:text-3xl font-black text-slate-900 dark:text-white'>Edit Profile</h1>
        ...
        <form onSubmit={handleSubmit} className='space-y-6' >
          ...
          <FormField label="Email Address (Fixed)" muted>
            <input
              type="email"
              className='w-full bg-slate-100 dark:bg-slate-800/50 rounded-xl sm:rounded-2xl p-3.5 sm-4 fornt-semibold text-slate-500 dark:text-slate-400 text-base cursor-not-allowed'
              disabled
