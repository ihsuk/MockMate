...
REM ===============================
start cmd /k "echo Pulling Mistral model... && ollama pull mistral && echo Starting Mistral... && ollama run mistral"

REM ===============================
REM Start AI Service (FastAPI)
REM ===============================
start cmd /k "cd /d "%ROOT%ai-service" && echo Activating virtual environment... && call venv\Scripts\activate && echo Installing Python dependencies... && pip install -r requirements.txt && echo Starting AI service... && python main.py"
